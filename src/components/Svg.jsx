...
export const Arrow = ({ className }) => {
    ...
    return (
        <svg className={`${className} cursor-pointer`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const Logo = ({className}) => (
    ...
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 51" preserveAspectRatio="xMinYMid slice">
